    ...
    el.innerHTML = data.map(e => {
      ...
      return `<details class="now-block now-block-collapsed">
        <summary class="now-block-header">
          ...
          <svg class="now-chevron" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg>
        </summary>
        ${mediaHtml}${bulletsHtml}
      </details>`;
    }).join('');
